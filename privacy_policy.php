...
<section class="PageCommonSetting">
	<div class="container">
		<div class="page_common_headeing_area">
			<h1 class="page_common_headeing">プライバシーポリシーについて</h1>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
				<div class="privacy_policy_area">
					<p class="privacy_policy_text">
						株式会社 LOGZ（以下「当社」）は、以下のとおり個人情報保護方針を定め、個人情報保護の仕組みを構築し、全従業員に個人情報保護の重要性の認識と取組みを徹底させることにより、個人情報の保護を推進致します。<br><br>

						<span class="privacy_policy_strong_point">1.&nbsp;個人情報の管理</span>
